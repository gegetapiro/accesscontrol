...
<body>
    ...
    <form id="inputautomatic">
        ...
        <br><br>
        <label for="codicefiscale">Inserisci codice fiscale <input type="text" id="codicefiscale" maxlength="16"
                oninput="putemploye('#codicefiscale')"></label>
    </form>
    <form id="inputkeyboard">
        <input type="button" value="PASSA AD INSERIMENTO AUTOMATICO" onclick="changeinputtype(1)">
        <br><br>
        <label for="codicefiscalemanual">Inserisci codice fiscale <input type="text" id="codicefiscalemanual"
                maxlength="16"></label>
